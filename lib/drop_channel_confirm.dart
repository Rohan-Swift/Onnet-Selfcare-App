...
class DropChannelsConfirm extends StatefulWidget {
  final List<String> selectedChannels;
  const DropChannelsConfirm({
    super.key,
    required this.selectedChannels,
  });

  @override
  State<DropChannelsConfirm> createState() => _DropChannelsConfirmState();
}

class _DropChannelsConfirmState extends State<DropChannelsConfirm> {
  String boxID = '';
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              await RemoveChannelsAPI().removeChannels();
                              setState(() {
                                cancelItems();
  ...
  void cancelItems() {
    ...
    globalRemoveChannels.clear();
    globalRemoveChannelIDs.clear();
    count = 0;
  }
}
